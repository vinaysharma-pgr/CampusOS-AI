...
console.log("");
console.log("PHASE 19 - STAGE 3 - ExamResult service/controller/routes");
console.log("");

writeIfMissing("backend/src/services/examResultService.js", `import Exam from "../models/Exam.js";
...
writeIfMissing("backend/src/controllers/examResultController.js", `import { asyncHandler } from "../utils/asyncHandler.js";
...
writeIfMissing("backend/src/routes/examResultRoutes.js", `import { Router } from "express";
